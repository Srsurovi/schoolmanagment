...
include("header.php");
	...
	if(isset($_POST["submit"])){
		...
		$result2=$db->query("insert into students(first_name,last_name,class_id,roll,section_id,birth_date,age,contact,email,address,city,country,reg_date,photo)values('$first_name','$last_name','$class','$roll','$section','$birth_date','$age','$contact','$email','$address','$city','$country','$reg_date','$target_dir')");
...
<div class="container">
	...
	<div class="card card-header">
		<h2>
			<a class="btn btn-info float-left" href="student_search.php">View All</a>
			<a class="btn btn-info float-left" href="student_search.php">search</a>
		</h2>
